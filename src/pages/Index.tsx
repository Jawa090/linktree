...
const Index = () => {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-2 sm:p-4">
      <div className="bg-card rounded-3xl shadow-xl border border-border overflow-hidden relative max-w-lg w-full mx-2 sm:mx-0">
        {/* Decorative curves */}
        ...
        <div className="p-4 sm:p-6 space-y-2">
          ...
          {/* Navigation Links */}
          <div className="border border-border rounded-2xl p-3 sm:p-4 space-y-3">
        ...
        {/* Footer */}
        <div className="text-center py-4 bg-muted border-t border-border">
